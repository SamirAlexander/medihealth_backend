...
@Getter
@Setter
public class DetalleAgendaMDTO {
    ...
    public DetalleAgendaMDTO() {
        // Constructor por defecto
    }
    public DetalleAgendaMDTO(Integer idAgenda, Date fechaCita, Integer idDetalleAgenda, Time horaInicio, Time horaFin,
