...
@Getter
@Setter
public class HistoriaClinicaPDTO {
    ...
    public HistoriaClinicaPDTO() {
    }

    public HistoriaClinicaPDTO(int idUsuario, String documentoIdentidad, String nombre, String apellido, String telefono,
